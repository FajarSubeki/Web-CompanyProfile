...
class Transmisi_model extends CI_Model {
    ...
    public $default_table = 't_transmisi';
   ...
   function count_by($id_user) {
        $this->db->select('*');
        $this->db->from('t_transmisi');
        $this->db->join('t_pemohon', 't_pemohon.id_pemohon = t_transmisi.id_pemohon');        
   ...
   function get_all_admin_proses() {
    ...
    function get_by_id_transmisi($id)
    {
